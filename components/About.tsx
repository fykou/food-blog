				...
				<div className='items-center lg:flex'>
					<div className='lg:w-1/2'>
						...
						<p className='mt-4 text-gray-500 dark:text-gray-400 lg:max-w-md'>
							Hi I am Emily, Lorem ipsum, dolor sit amet consectetur adipisicing elit. Illum in sed non
							alias, fugiat, commodi nemo ut fugit corrupti dolorem sequi ex veniam consequuntur id,
